...
import { selectPizzasCount, selectCartTotal } from "../store/cartSlice";

const Header = () => {
  const [isFocused, setIsFocused] = useState(false);
  const pizzaCount = useAppSelector(selectPizzasCount);
      ...
      <div className="flex-none">
        ...
        >
          <div className="indicator">
            ...
            <span className="badge badge-sm indicator-item">{pizzaCount}</span>
          </div>
        </Link>
      </div>
    </div>
